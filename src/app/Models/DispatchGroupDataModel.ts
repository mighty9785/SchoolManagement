export class DispatchGroupDataModel {

  public GroupDataModel: DispatchGroupcodelModel[]=[]
...
export class DispatchGroupSearchModel {
  public DispatchGroupID: number = 0;
/*  public DispatchDate: string = '';*/
  public DepartmentID: number = 0;
  public CourseTypeID: number = 0;
...
export class DispatchGroupcodelModel {
  public InstituteID:number=0
...
export class InstituteGroupDetail {
...
export class RevalDispatchGroupDataModel {

  public GroupDataModel: RevalDispatchGroupcodeModel[] = []
  public DispatchGroupID: number = 0;
  public DispatchDate: string = '';
  public CompanyName: string = '';
  public ChallanNo: string = '';
...
export class RevalDispatchGroupcodeModel {
  public InstituteID: number = 0
  public GroupID: number = 0
  public DispatchGroupID: number = 0
  public GroupCode: string = ''
