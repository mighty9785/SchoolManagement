...
export class ITIPrivateEstablish_StaffDetailsDataModel {
  ...
  public EduQualificationDetailsModel: ITIPrivateEstablish_Staff_EduQualificationDetailsModel[] = [];
  public StaffSubjectListModel: ITIPrivateEstablish_StaffSubjectList[]= [];
}

export class ITIPrivateEstablish_Staff_EduQualificationDetailsModel {
...
export class ITIPrivateEstablish_AddStaffBasicDetailDataModel extends RequestBaseModel {
  // public StaffID: number = 0;
  ...
  public HostelIDs: ITIPrivateEstablish_StaffHostelListModel[] = [];
...
export class ITIPrivateEstablish_StaffMasterSearchModel {
  public StaffID: number = 0
  public StaffTypeID: number = 0;
  public RoleID: number = 0;
  public SubjectID: number = 0;
...
export class ITIPrivateEstablish_StaffSubjectList {
...
export class ITIPrivateEstablish_StaffHostelListModel {
